...
* Added ``fmt::join()`` function that takes a range and formats it elements separated by a given string (`#466 <https://github.com/fmtlib/fmt/pull/466>`_). Thanks `@olivier80 <https://github.com/olivier80>`_.

* Supported custom formatting specifications to simplify customize built-in formatting (`#444 <https://github.com/fmtlib/fmt/pull/444>`_). Thanks `@polyvertex (Jean-Charles Lefebvre) <https://github.com/polyvertex>`_. See also `#439 <https://github.com/fmtlib/fmt/issues/439>`_.

* Added ``fmt::format_system_error()`` for error code formatting (`#323 <https://github.com/fmtlib/fmt/issues/323>`_).
